...
def forward():
    ...
    api_key = "FTgHUVjcPWvgzCvtksi2v+tMLTAXbh5LLVEl1Wcl4NAtszxElZL4HS/ZwJqJufRkEmRpwUTwULxsZgL2c649vQ=="
    phone_number = "14084299128"
    messages = ["Hello, citibank is offering you an amazing discount on your favorite armani watch!", "Invest in this abc policy today and after 3 months you can try your favorite sky diving!"]
